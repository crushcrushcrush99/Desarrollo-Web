...
const app = express()
const port = 8070
const connection = "mongodb+srv://admin:teste123@appdb.wv6kdpm.mongodb.net/?retryWrites=true&w=majority"
...
app.post('/adicionar-produto', async (req, res) =>{
    try{
        ...
        return res.status(201).json({message: "Produto adicionador com sucesso!"})     
    }catch (error){
